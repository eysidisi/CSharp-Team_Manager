...
{
    public class NewTeamPageServiceTestsMySQL : NewTeamPageServiceTests
    {
        ...
        {
            ManagerMySQLDatabaseConnection connection = new ManagerMySQLDatabaseConnection(connectionString);
